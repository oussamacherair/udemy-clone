                ...
                <div>
                    <div className='bg-[#2d2f31] text-white lg:pb-8 lg:pt-4 lg:pr-44'>
                        ...
                        <div className='relative'>
                            <img className='w-full h-auto block lg:hidden' src={image_480x270} alt={image_480x270} />
                        ...
                        <div className='p-5'>
                            ...
                            <div>
                                ...
                                <h2 className='text-xs md:text-sm lg:text-2xl line-clamp-2 font-thin'>{headline}</h2>
                            ...
                            <div>
                                ...
                                <p className='py-1 block  text-sm text-center lg:hidden'>30-Day Money-Back Guarantee</p>
