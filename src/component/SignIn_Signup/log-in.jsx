    ...
    <div className="p-10 mx-auto">
      <div className="w-full md:w-80 mx-auto">
        ...
        <div>
          <div
            onClick={() => GoogleSign()}
            className="flex my-2 items-center  justify-start w-full  px-4 py-2 border-2 border-black font-bold text-md cursor-pointer hover:bg-gray-100"
          >
          ...
          <div
            ...
            className="flex my-2 justify-start items-center w-full  px-4 py-2 border-2 border-black font-bold text-md cursor-pointer hover:bg-gray-100"
          >
        ...
        <p className="text-center">
          ...
          <span
            onClick={SignUp}
            className="text-purple-700 underline capitalize font-bold cursor-pointer"
          >
            Sign up
            <br />
