...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-6 pl-8  w-full justify-self-end self-end">
      <div className="container mx-auto flex flex-wrap justify-between">
        ...
        <div className="w-full sm:-1/2 md:w-1/3 lg:w-1/4 mt-4">
          <div className='border-2 w-1/2 border-white flex items-center py-3 px-4'>
      ...
      <div className="text-center md:text-right my-3 px-7">
